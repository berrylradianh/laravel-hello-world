...
<html>
<head>
<title>Flower Shop - Category</title>
...
<div id="wrap">
  <div class="header">
    ...
    <div id="menu">
      <ul>
        ...
        <li class="selected"><a href="category">flowers</a></li>
  ...
  <div class="center_content">
    <div class="left_content">
      ...
      <div class="title"><span class="title_icon"><img src="{{asset('images/bullet1.gif')}}" alt="" /></span>Category products</div>
